        ...
        <div class="card-body p-4">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody id="tabelRumusBody">
                        <?php $__currentLoopData = $semua_rumus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center"><?php echo e($key + 1); ?></td>
                            <td><?php echo e($r->nama_rumus); ?></td>
                            <td class="text-center">
                                <span class="badge bg-secondary"><?php echo e($r->kategori); ?></span>
                            </td>
                            <td class="text-center">
                                <a href="<?php echo e(route('rumus.show', $r->id)); ?>" class="btn btn-primary btn-sm">
                                    <i class="fas fa-eye"></i> Detail
                                </a>
                                <button class="btn btn-warning btn-sm text-white" data-bs-toggle="modal" data-bs-target="#ER1-<?php echo e($r->id); ?>">
                                    <i class="fas fa-edit"></i> Edit
                                </button>
                                <form action="<?php echo e(route('rumus.destroy', $r->id)); ?>" method="POST" class="d-inline">
                        ...
                        <div class="modal fade" id="ER1-<?php echo e($r->id); ?>" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content border-0 shadow">
                                    <form action="<?php echo e(route('rumus.update', $r->id)); ?>" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_rumus" class="form-control" value="<?php echo e($r->nama_rumus); ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Kategori</label>
                                                <input type="text" name="kategori" class="form-control" value="<?php echo e($r->kategori); ?>" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Isi Rumus (Latex/Teks)</label>
                                                <textarea name="isi_rumus" class="form-control" rows="3" required><?php echo e($r->isi_rumus); ?></textarea>
                                            </div>
                                        </div>
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <span class="small text-muted" id="summaryRumus">
                    Showing 1 to <?php echo e(count($semua_rumus)); ?> of <?php echo e(count($semua_rumus)); ?> entries
                </span>
                <nav>
...
<div class="modal fade" id="TR1" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            <form action="<?php echo e(route('rumus.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-header border-0 pb-0">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const totalEntries = <?php echo e(count($semua_rumus)); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\L\laragon\www\mlfrp\resources\views/admin/rumus/index.blade.php ENDPATH**/ ?>