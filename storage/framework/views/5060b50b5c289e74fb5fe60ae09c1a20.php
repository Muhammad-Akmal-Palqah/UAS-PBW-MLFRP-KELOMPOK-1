        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body p-5">
                    ...
                    <hr class="my-4">
                    <a href="<?php echo e(route('publik.katalog.alat')); ?>" class="btn btn-outline-secondary btn-sm">
...
<?php echo $__env->make('layouts.publik', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laragon\www\mlfrp\resources\views/frontend/das.blade.php ENDPATH**/ ?>