        ...
        <div class="card-body p-4">
                ...
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody id="tokohTableBody">
                        ...
                        <tr>
                            ...
                            <td class="fw-bold"><?php echo e($t->nama_tokoh); ?></td>
                            <td class="text-center">
                                <img src="<?php echo e(asset('storage/'.$t->foto)); ?>" width="80" class="rounded shadow-sm border">
                            </td>
                            <td class="text-center">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <span class="small text-muted" id="summaryTokoh">
                    Showing 1 to <?php echo e(count($semua_tokoh)); ?> of <?php echo e(count($semua_tokoh)); ?> entries
                </span>
                <nav>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const totalEntries = <?php echo e(count($semua_tokoh)); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\L\laragon\www\mlfrp\resources\views/admin/halloffame/index.blade.php ENDPATH**/ ?>