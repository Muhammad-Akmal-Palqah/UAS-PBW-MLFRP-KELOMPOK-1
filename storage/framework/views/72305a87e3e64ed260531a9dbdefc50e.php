        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <span class="small text-muted" id="summaryText">
                    Showing 1 to <?php echo e(count($semua_jurnal)); ?> of <?php echo e(count($semua_jurnal)); ?> entries
                </span>
                <nav>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const totalInitial = <?php echo e(count($semua_jurnal)); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\L\laragon\www\mlfrp\resources\views/admin/repositori/index.blade.php ENDPATH**/ ?>