...
<div class="card login-card bg-white">
    <div class="card-body">
        <div class="text-center mb-4">
            ...
            <p class="text-muted small">Manajemen Laboratorium Fisika & Repositori Penelitian</p>
            <hr>
        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('publik.index')); ?>" class="btn btn-success">
                MASUK TAMU
            </a>
             </div>
        </form>
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\L\laragon\www\mlfrp\resources\views/auth/login.blade.php ENDPATH**/ ?>