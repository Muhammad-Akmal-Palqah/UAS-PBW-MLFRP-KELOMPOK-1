        ...
        <div class="card-body p-4">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody id="tabelModulBody">
                        <?php $__currentLoopData = $semua_modul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center"><?php echo e($key + 1); ?></td>
                            <td class="fw-bold"><?php echo e($m->nama_modul); ?></td>
                            <td class="text-center">
                                <span class="badge bg-primary"><?php echo e($m->kategori); ?></span>
                            </td>
                            <td class="text-center">
                                <a href="<?php echo e(asset('storage/'.$m->file_path)); ?>" class="btn btn-info btn-sm text-white" target="_blank">
                                    <i class="fas fa-download"></i> Download
                                </a>
                                <form action="<?php echo e(route('modul.destroy', $m->id)); ?>" method="POST" class="d-inline">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <span class="small text-muted" id="summaryModul">
                    Showing 1 to <?php echo e(count($semua_modul)); ?> of <?php echo e(count($semua_modul)); ?> entries
                </span>
                <nav>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const totalEntries = <?php echo e(count($semua_modul)); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\L\laragon\www\mlfrp\resources\views/admin/modul/index.blade.php ENDPATH**/ ?>