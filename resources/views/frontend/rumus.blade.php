        ...
        <div class="card-body p-4">
             <div class="d-flex justify-content-between mb-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <input type="text" id="searchRumus" class="form-control form-control-sm" placeholder="Cari rumus...">
                </div>
            </div>
            <div class="table-responsive">
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody id="rumusTableBody">
                        @foreach($semua_rumus as $key => $r)
                        <tr>
                            <td class="text-center">{{ $key + 1 }}</td>
                            <td class="fw-bold">{{ $r->nama_rumus }}</td>
                            <td class="text-center">
                                <span class="badge bg-secondary">{{ $r->kategori }}</span>
                            </td>
                            <td class="text-center">
                                <a href="{{ route('publik.rumus.show', $r->id) }}" class="btn btn-primary btn-sm">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const searchInput = document.getElementById('searchRumus');
        const tableBody = document.getElementById('rumusTableBody');
        ...
        searchInput.addEventListener('keyup', function() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                // Mencari di seluruh teks dalam baris (Nama Rumus & Kategori)
