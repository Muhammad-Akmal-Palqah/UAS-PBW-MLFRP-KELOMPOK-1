        ...
        <div class="col-md-6 col-lg-4">
            <div class="card card-menu shadow-sm h-100 p-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('publik.katalog.alat') }}" class="btn btn-outline-success btn-sm w-100 mt-3">Buka Katalog</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card card-menu shadow-sm h-100 p-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('publik.kalender') }}" class="btn btn-outline-success btn-sm w-100 mt-3">Cek Kalender</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card card-menu shadow-sm h-100 p-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('publik.rumus') }}" class="btn btn-outline-success btn-sm w-100 mt-3">Lihat Rumus</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card card-menu shadow-sm h-100 p-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('publik.repositori') }}" class="btn btn-outline-success btn-sm w-100 mt-3">Lihat Arsip</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card card-menu shadow-sm h-100 p-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('publik.halloffame') }}" class="btn btn-outline-success btn-sm w-100 mt-3">Buka Data</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card card-menu shadow-sm h-100 p-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('publik.event') }}" class="btn btn-outline-success btn-sm w-100 mt-3">Lihat Event</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card card-menu shadow-sm h-100 p-3">
                <div class="card-body d-flex flex-column">
                    ...
                    <a href="{{ route('publik.modul') }}" class="btn btn-outline-success btn-sm w-100 mt-3">Lihat Modul</a>
                </div>
            </div>
        </div>
