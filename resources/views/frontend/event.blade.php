        ...
        <div class="card-body p-4">
             <div class="d-flex justify-content-between mb-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <input type="text" id="searchEvent" class="form-control form-control-sm" placeholder="Cari nama event atau lokasi...">
                </div>
            </div>
                ...
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody id="eventTableBody">
                        ...
                        <tr id="noResults" style="display: none;">
                            <td colspan="4" class="text-center text-muted py-3">Event tidak ditemukan...</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchInput.addEventListener('keyup', function() {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                // Mencari teks di seluruh baris (Nama Event, Tanggal, Lokasi)
