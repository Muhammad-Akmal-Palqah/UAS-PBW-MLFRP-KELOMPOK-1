                ...
                <table class="table table-bordered table-hover align-middle">
                    ...
                    <tbody id="alatTableBody">
                        ...
                        <tr>
                            ...
                            <td class="nama-barang">{{ $a->nama_barang }}</td>
                            <td class="text-center">
                                <img src="{{ asset('storage/'.$a->gambar) }}" width="80" class="rounded shadow-sm">
                            </td>
                            <td class="text-center">
                                <a href="{{ route('alat.show', $a->id) }}" class="btn btn-primary btn-sm">
                                    <i class="fas fa-eye"></i> Detail
                                </a>
                                <button class="btn btn-warning btn-sm text-white" data-bs-toggle="modal" data-bs-target="#EKA1-{{ $a->id }}">
                        ...
                        <div class="modal fade" id="EKA1-{{ $a->id }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content border-0 shadow">
                                    <form action="{{ route('alat.update', $a->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf @method('PUT')
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="nama_barang" class="form-control" value="{{ $a->nama_barang }}" required>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="deskripsi" class="form-control" rows="4">{{ $a->deskripsi }}</textarea>
                                            </div>
                                        </div>
